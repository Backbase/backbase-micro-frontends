...
export const APP_TRANSACTIONS_BASE_PATH = new InjectionToken<string>(
  'ServicePathsModule::APP_TRANSACTIONS_BASE_PATH',
);
...
export const APP_BATCH_PAYMENT_BATCH_UPLOAD_MAPPING_BASE_PATH =
  new InjectionToken<string>(
    'ServicePathsModule::APP_BATCH_PAYMENT_BATCH_UPLOAD_MAPPING_BASE_PATH',
  );
export const APP_BATCH_PAYMENT_BATCH_TEMPLATE_BASE_PATH =
  new InjectionToken<string>(
...
export const APP_ENGAGEMENT_BASE_PATH = new InjectionToken<string>(
  'ServicePathsModule::APP_ENGAGEMENT_BASE_PATH',
);

export const APP_PLACES_BASE_PATH = new InjectionToken<string>(
  'ServicePathsModule::APP_PLACES_BASE_PATH',
);
...
export const APP_STOP_CHECKS_BASE_PATH = new InjectionToken<string>(
  'ServicePathsModule::APP_STOP_CHECKS_BASE_PATH',
);
 ...
 */
export const APP_FINANCIAL_INSTITUTION_MANAGER_BASE_PATH =
  new InjectionToken<string>(
    'ServicePathsModule::APP_FINANCIAL_INSTITUTION_MANAGER_BASE_PATH',
  );

export const APP_LOANS_JOURNEY_BASE_PATH = new InjectionToken<string>(
  'ServicePathsModule::APP_LOANS_BASE_PATH',
);
export const APP_CARDS_BASE_PATH = new InjectionToken<string>(
  'ServicePathsModule::APP_CARDS_BASE_PATH',
);
...
export const APP_DEVICE_BASE_PATH = new InjectionToken<string>(
  'ServicePathsModule::APP_DEVICE_BASE_PATH',
);
